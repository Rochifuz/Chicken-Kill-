...
namespace EasyPrimitiveAnimals
{
    public class AnimalController : MonoBehaviour
    {
        ...
        private void Update()
        {
            if (!this.gameObject.CompareTag("Enemigo")) // If animal the script is attached to is not a chicken, animate 4 legs and body.
            {
        ...
        {
            if (!collision.gameObject.CompareTag("floor") && canRotate) // If the animal collides with something that is not the ground, spin it around.
            {
