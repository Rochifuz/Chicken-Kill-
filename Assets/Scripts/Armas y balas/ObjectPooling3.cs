...
public class ObjectPooling3 : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        for(int i = 0; i<bulletAmount; i++)
        {
            ...
            BPrefab.scriptBullet3 = BPrefab.prefab.GetComponent<Bullet1>();
            bullets.Add(BPrefab);        
        }
    }

    public GameObject GetBullet3(bool isPlayer)//esto define si el disparo lo realizo un jugador o un enemigo
    {
        ...
        for(int i=0; i<totalBullets; i++)
        {
            if(!bullets[i].prefab.activeInHierarchy)//Define si la bala la dispara un jugador o enemigo y si una bala se encuentra en false la pasa a true
            {
                ...
                bullets[i].scriptBullet3.shootByPlayer = isPlayer;
        ...
        BPrefab.scriptBullet3 = BPrefab.prefab.GetComponent<Bullet1>();
        BPrefab.scriptBullet3.shootByPlayer = isPlayer;
        bullets.Add(BPrefab);
